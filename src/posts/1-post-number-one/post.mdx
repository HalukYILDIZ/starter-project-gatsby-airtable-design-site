...
<blockquote display="info">herşey çok güzel başlamıştı</blockquote>

![deneme resmi](./images/html-1.png)

<RegVideo />
<Video src="https://www.youtube.com/embed/IH_kGijV8so" />

<h2 title>random h2</h2>

<h4>random h4</h4>

`console.log("deneme");`

<h4>blockqoute element</h4>

<blockquote display="info">
  umblebrag neutra taiyaki af vice bespoke locI'm baby tumblr fanny pack tousled
  seitan. Man bun shaman yr, bushwick fam hammock williamsburg kombucha keytar
  VHS. Chambray street art authentic,
</blockquote>
